...
| [Quick Path to Create RDS SQL Server Enterprise Edition Primary instance and Read-Only instance](https://github.com/alibabacloud-howto/terraform-templates/tree/master/terraform-alicloud-db-samples/rds-sqlserver-ro) | Create and setup RDS SQL Server enterprise edition primary instance and Read-Only instance. | RDS SQL Server | [:clapper:](https://www.youtube.com/watch?v=b_1-qcMeyPU) | |
| [Quick Path to Build OLTP (RDS MySQL) & OLAP (AnalyticDB MySQL) Cluster with Data Synchronization Channel](https://github.com/alibabacloud-howto/terraform-templates/tree/master/terraform-alicloud-db-samples/dts/data_synchronization/rdsmysql-adbmysql) | Using terraform script to build OLTP (RDS MySQL) and OLAP (AnalyticDB MySQL) cluster with DTS data synchronization channel. | EIP, ECS, RDS MySQL, AnalyticDB MySQL | [:clapper:](https://www.youtube.com/watch?v=R34UdUb80PI) | |
...
| [Provision RDS MySQL automatically using Terraform "remote-exec" provisioner](https://github.com/alibabacloud-howto/terraform-templates/tree/master/terraform-alicloud-db-samples/rds-mysql-provisioner-remote-exec-sqlfile) | Use Terraform "remote-exec" provisioner to provision RDS MySQL automatically. | RDS MySQL | [:clapper:](https://www.youtube.com/watch?v=c0P_gFk8_sE) | |
